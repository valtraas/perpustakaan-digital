                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 " action="{{ route('register.user') }}" method="POST">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="nama_lengkap" class="form-control" id="yourName"
                                                required name="nama_lengkap" required>
                                            @error('nama_lengkap')
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="username" class="form-control" id="yourUsername"
                                                required name="username" required>
                                            @error('username')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">sudah punya akun? <a href="{{ route('login.index') }}">Log
                                                    in</a></p>
                                        </div>
                                    </form>
